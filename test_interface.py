...
def testsMain():
    ...
    # model_result = "LEVR_share_ota_zset_pro_policy_model_",model
    # eui_result = "LEVR_share_ota_zset_pro_policy_eui_",eui
    # print r.keys("*ota*")
    # print r.zrange(model_result, 0, -1, False, True)
    # # r.zinterstore("test", ("LEVR_share_ota_zset_pro_policy_eui_58018", "LEVR_share_ota_zset_pro_policy_model_FCX"),
    # #               aggregate="MAX")
    # # print(r.zscan("test"))
